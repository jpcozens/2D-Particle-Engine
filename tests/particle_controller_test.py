...
def test_start():
    ...
    particle_controller_test_instance = Particle_Controller((1920, 1080), particle_mode=Particle.MODE_ELLIPSE, particle_size=(2,2))
    ...
    for particle_test_instance in particle_controller_test_instance.particles:
        assert particle_test_instance.acceleration == (0,0)
        assert particle_test_instance.size == (2,2)
